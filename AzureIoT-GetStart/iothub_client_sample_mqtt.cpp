...
void iothubSendMessage(const unsigned char *text ,bool humidityAlert)
{
    if (messageSending && !messagePending)
    {
        ...
        //Map_Add(properties, "temperatureAlarm", temperatureAlert ? "1" : "0");
        //Map_Add(properties, "HumidityAlarm", humidityAlert ? "1" : "0");
